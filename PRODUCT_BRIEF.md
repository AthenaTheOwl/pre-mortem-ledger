...
- [`SYSTEM_MAP.md`](SYSTEM_MAP.md) — inputs, outputs, gates, modules.
- [`docs/METHODOLOGY.md`](docs/METHODOLOGY.md) — how to author a useful
  pre-mortem and how the status enum maps to decisions.
- [`decisions/`](decisions) — design-decision records.
- [`specs/0002-design/`](specs/0002-design) — the v0.1 design ledger.
